...
- [x] **Phase 1: Voice Pipeline Server + Walkie-Talkie Frontend** - Platform-agnostic Node.js server exposing STT/LLM/TTS pipeline over WebSocket with Vite frontend press-to-talk UI
...
Plans:
- [x] 01-01-PLAN.md — Foundation: install deps, tsconfigs, folder structure, .env.example, vitest
- [x] 01-02-PLAN.md — Server lib migrations: stt.ts, tts.ts, llm.ts + shared protocol types
- [x] 01-03-PLAN.md — Server core: pipeline singleton + WebSocket route handler (full STT→LLM→TTS)
- [x] 01-04-PLAN.md — Server entry: Express + ws wired together (health route, pipeline gating)
- [x] 01-05-PLAN.md — Frontend: Vite config, React app, press-to-talk UI, audio utilities
- [x] 01-06-PLAN.md — IoT protocol documentation (docs/iot-protocol.md)
- [x] 01-07-PLAN.md — Verification: unit tests + human end-to-end checkpoint

## Progress

| Phase | Plans Complete | Status | Completed |
|-------|----------------|--------|-----------|
| 1. Voice Pipeline Server + Walkie-Talkie Frontend | 7/7 | Completed | 2026-05-16 |
